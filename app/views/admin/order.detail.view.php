    ...
    <div class="w-100 h-100 p-5">
        <div class="dashboard-header d-flex flex-row align-items-center justify-content-space-between w-100">
            ...
            <div class="dashboard-buttons">
                ...
                <a class="btn btn-primary text-uppercase fw-bold" href=<?=ROOT."/admin/orders/delete/".$order->order_id?> id="delete-button">Delete</a>
            </div>
        </div>
        <div class="blur-container">
            ...
            <h4 class="type-display" data-type="<?=$order->type?>">Order Type: <?php
