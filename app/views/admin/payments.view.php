...
<div class="dashboard-container">
    ...
    <div class="w-100 h-100 p-5">
        ...
        <div class="w-100 p-2 d-flex justify-content-space-evenly" style="background-color: red"><span class="btn"
                                                                                                       id="unpaid-header">Unpaid</span><span
                class="btn" id="tocollect-header">To Collect</span></div>
