    ...
    <div class="w-100 h-100 p-5">
        <div class="dashboard-header d-flex flex-row align-items-center justify-content-space-between w-100">
            ...
            <div class="dashboard-buttons" style="width:400px;">
                ...
                <a class="btn btn-primary text-uppercase fw-bold d-inline-block" href="<?php echo ROOT ?>/admin/payments/addOrder"
                   id="add-order-button">+ Create Order</a>

            </div>
        </div>
        <div class="w-100 p-2 d-flex justify-content-space-evenly" style="background-color: red"><span class="btn" id="unpaid-header">Unpaid</span><span class="btn" id="tocollect-header">To Collect</span></div>
