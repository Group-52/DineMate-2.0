<div id="sidebar" class="sidebar pb-5 pt-4 px-4">
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "items") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && ($controller == "inventory")) echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "ingredients") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "menus") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "purchases") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "dishes") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "promotions") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "vendors") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "feedback") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "orders") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "users") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "employees") echo " active" ?>"
    ...
    <a class="fw-bold d-block mb-4 fs-5<?php if (isset($controller) && $controller == "payments") echo " active" ?>"
