...
INSERT INTO `dishes` (`dish_id`, `dish_name`, `net_price`, `selling_price`, `description`, `prep_time`, `image_url`)
VALUES (33, 'Pizza', 800, 1000, 'Cheesy tasty', 60, 'Pizza06_24_40.jpg'),
...
INSERT INTO `employees` (`emp_id`, `first_name`, `last_name`, `username`, `salary`, `contact_no`, `NIC`,
                         `date_employed`, `role`, `email`, `password`, `last_login`)
VALUES (1, 'Janet', 'Pym', 'jp', 100000, '0724573075', '1234567890', '2012-11-09', 1, 'jp@xmail.com', 'janet',
        '2022-12-01 18:30:00'),
       (2, 'ron', 'weasley', 'rw@xmail.com', 0, '3', '', '0000-00-00', 2, 'rw@xmail.com',
        '$2y$10$SNBMsJ6bqPV/61kRqwbH2eETa7pYDObU9r0bfPQWCkvAQ4xEOQcBC', '2022-12-16 04:47:16'),
       (3, 'hermione', 'granger', 'hg@xmail.com', 0, '1', '', '0000-00-00', 2, 'hg@xmail.com',
        '$2y$10$XZiLEyvBtcEQhr6LydKwXO4wXg5UjoSQxQ.Z8v26JuFU5WchxXUNW', '2022-12-16 05:33:41'),
       (4, 'Nipun', 'Weerasiri', 'nipun', 0, '', '', '0000-00-00', 4, 'nipun@email.com',
        '$2y$10$Mza4PDo2jJyWnhPTBY.tH.XO65n4keDIpEu0iHH1q43gdNSy/Hd1K', '2022-12-16 09:48:17'),
       (5, 'hf', 'uhauf', 'hu@gmail.com', 0, '3243', '', '0000-00-00', 2, 'hu@gmail.com',
        '$2y$10$Qi8iSg3weRpDOz.1H2fEAOk2eM6ncwVaLr.SxxubfuHhkhfN.Pa8C', '2022-12-16 09:54:19');
...
INSERT INTO `feedback` (`feedback_id`, `reg_customer_id`, `guest_id`, `order_id`, `rating`, `description`,
                        `time_placed`)
VALUES (1, 2, NULL, 1, 3, 'Good stuff', '2023-02-02 12:15:46'),
...
INSERT INTO `ingredients` (`dish_id`, `item_id`, `quantity`, `unit`)
VALUES (33, 2, 0.5, 1),
       (33, 3, 0.036, 8),
       (33, 10, 0.109, 6),
       (33, 13, 100, 7),
...
INSERT INTO `inventory` (`item_id`, `amount_remaining`, `last_updated`, `max_stock_level`, `buffer_stock_level`,
                         `reorder_level`, `lead_time`)
VALUES (2, 43, '2023-02-05 11:54:49', 115, 97, 44, 20),
...
INSERT INTO `inventory2` (`pid`, `item_id`, `amount_remaining`, `special_notes`, `expiry_risk`, `last_used`)
VALUES (71, 15, 7, 'Jesus made this ', 1, '2023-02-06 12:29:07'),
...
--
DELIMITER $$
CREATE TRIGGER `update_amount_remaining`
    AFTER UPDATE
    ON `inventory2`
    FOR EACH ROW
BEGIN
...
INSERT INTO `items` (`item_id`, `item_name`, `description`, `unit`, `category`)
VALUES (2, 'Dhal', 'always keep at hand', 1, 3),
...
INSERT INTO `menus` (`menu_id`, `menu_name`, `description`, `start_time`, `end_time`, `image_url`, `all_day`)
...
INSERT INTO `promotions` (`promo_id`, `caption`, `type`, `status`, `image_url`)
VALUES (1, 'This is my discount promotion 1', 'discounts', 1, NULL),
...
INSERT INTO `promo_discounts` (`promo_id`, `dish_id`, `discount`)
VALUES (1, 38, 3);
...
INSERT INTO `purchases` (`purchase_id`, `item`, `quantity`, `vendor`, `brand`, `purchase_date`, `expiry_date`, `cost`,
                         `discount`, `tax`, `final_price`)
VALUES (71, 15, 43, 7, NULL, '2023-02-01', '2023-09-14', 423, 0, 0, 423),
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_inventory2`
    AFTER INSERT
    ON `purchases`
    FOR EACH ROW
BEGIN
...
VALUES (1, 'Clint', 'Barton', '555', 'cb@xmail.com', '$2y$10$tHdvolbPMWUhtVzFTe/U9upVSyxcJ.RxDA15aBbqmIBaGmr4XalKa',
        '2022-11-19 11:07:40', '2022-12-01 18:30:00', 0),
       (2, 'Bruce', 'Wayne', '1234', 'bw@xmail.com', '$2y$10$n2MLfG2NVoAyw5kM7WHrPePkaM9oVODNU8FYymBh68MZkt2YrlbdW',
        '2022-12-03 20:37:41', '2022-12-03 20:37:41', 0),
       (3, 'Thor', 'Odinson', '1234', 'to@xmail.com', '$2y$10$W5tNA5WjXlBjS6bE7tB7CehMFlmkE2mFsh1jZ5v75Tzc3fK1voi8G',
        '2022-12-04 07:32:30', '2022-12-04 07:32:30', 0),
       (6, 'Andrew', 'Tate', '1', 'at@xmail.com', '$2y$10$gqM/6DlLpjgtbUqLwL9lzetNEIGT6w6KV44aG4miDNhIl5WMRGHAu',
        '2022-12-15 05:39:19', '2022-12-15 05:39:19', 0),
       (10, 'Nipun', 'Weerasiri', '0703489775', 'nipunchamikara@yahoo.com',
        '$2y$10$cPuKs8x/V/F0CaomtJq8nOkarvuKIRfOL2cMZ5SQRTJoXuOZ3d8wi', '2023-01-08 19:23:09', '2023-01-08 19:23:09',
        1),
       (11, 'Sandul', 'Renuja', '0775415464', 'sandulrenuja@gmail.com',
        '$2y$10$whGLeFNbZrcN/zWWgT2xYeJvt9QHFFQ7Y0xWWkX3iMZOr/PyxyILy', '2023-02-09 21:06:29', '2023-02-09 21:06:29',
        1);
...
INSERT INTO `units` (`unit_id`, `unit_name`, `abbreviation`, `type`)
VALUES (1, 'kilograms', 'kg', 'mass'),
       (2, 'grams', 'g', 'mass'),
...
INSERT INTO `unit_conversion` (`u1`, `u2`, `conversion_factor`)
VALUES (1, 2, 1000),
       (4, 3, 1000),
       (7, 2, 28.3495),
       (8, 2, 453.592),
...
INSERT INTO `vendors` (`vendor_id`, `vendor_name`, `address`, `company`, `contact_no`, `email`)
VALUES (1, 'Lana', 'Madrid, Spain', 'Rhoedes Inc.', '0724573075', NULL),
       ...
       (10, 'Priyanka Gandhi', '212223 Rosewood Ave', 'Indian National Congress', '555-555-5561',
        'priyankagandhi@inc.com'),
       (11, 'Nirmala Sitharaman', '242526 Cedar Ln', 'Bharatiya Janata Party', '555-555-5562',
        'nirmalasitharaman@bjp.com'),
